<table class="table table-condensed in" id="feeds"></table>

<div id="mygraphs" class="in">
    <h4><a href="#" class="collapsed" data-toggle="collapse" data-target="#graph-list"><?php echo _('My Graphs') ?> <span class="arrow arrow-down pull-right"></span></a></h4>
